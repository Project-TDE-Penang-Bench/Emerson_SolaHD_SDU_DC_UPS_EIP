...
var $jscomp = {
  scope: {},
  findInternal: function (n, p, A) {
    n instanceof String && (n = String(n));
    for (var F = n.length, G = 0; G < F; G++) {
      var la = n[G];
      if (p.call(A, la, G, n)) return { i: G, v: la };
    }
    return { i: -1, v: void 0 };
  },
};
$jscomp.defineProperty =
  "function" == typeof Object.defineProperties
    ...
    : function (n, p, A) {
        ...
        n != Array.prototype && n != Object.prototype && (n[p] = A.value);
      };
...
$jscomp.polyfill = function (n, p, A, F) {
  if (p) {
    A = $jscomp.global;
    n = n.split(".");
...
(function (n, p) {
  ...
  function G(a, b, d, e) {
    if (c.acceptData(a)) {
      var f = c.expando,
        ...
        k = h ? c.cache : a,
        l = h ? a[f] : a[f] && f;
      if ((l && k[l] && (e || k[l].data)) || !g || d !== p) {
        l || (h ? (a[f] = l = ba.pop() || c.guid++) : (l = f));
    ...
    if (c.acceptData(a)) {
      ...
      if (k[l]) {
        if (b && (g = d ? k[l] : k[l].data)) {
          ...
          if (!(d ? Fa : c.isEmptyObject)(g)) return;
        }
        if (!d && (delete k[l].data, !Fa(k[l]))) return;
        h
          ? c.cleanData([a], !0)
          : c.support.deleteExpando || k != k.window
          ? delete k[l]
          : (k[l] = null);
      }
    }
  ...
  function ab(a, b, d) {
    if (d === p && 1 === a.nodeType)
      if (
        ((d = "data-" + b.replace(Vb, "-$1").toLowerCase()),
        (d = a.getAttribute(d)),
        "string" === typeof d)
      ) {
        try {
  ...
  function cb(a, b, d) {
    ...
    if ("string" === typeof b) {
      ...
      if (Xb.test(b)) return c.filter(b, e, !d);
      b = c.filter(b, e);
    }
    return c.grep(a, function (a) {
  ...
  function z(a, b) {
    var d,
      ...
      f = 0,
      g =
        typeof a.getElementsByTagName !== O
          ? a.getElementsByTagName(b || "*")
          : typeof a.querySelectorAll !== O
          ? a.querySelectorAll(b || "*")
          : p;
    if (!g)
      for (g = [], d = a.childNodes || a; null != (e = d[f]); f++)
        !b || c.nodeName(e, b) ? g.push(e) : c.merge(g, z(e, b));
  ...
  function ib(a, b) {
    if (b in a) return b;
    for (
      var c = b.charAt(0).toUpperCase() + b.slice(1), e = b, f = jb.length;
      f--;

    )
      if (((b = jb[f] + c), b in a)) return b;
    return e;
  }
  function ma(a, b) {
    a = b || a;
        ...
        e.style &&
          ...
          b
            ? (g[h] || "none" !== d || (e.style.display = ""),
              "" === e.style.display &&
                ma(e) &&
                (g[h] = c._data(e, "olddisplay", lb(e.nodeName))))
            : g[h] ||
              ((f = ma(e)),
              ((d && "none" !== d) || !f) &&
  ...
  function nb(a, b, d, e, f) {
    ...
    for (var g = 0; 4 > b; b += 2)
      "margin" === d && (g += c.css(a, d + Y[b], !0, f)),
        e
          ? ("content" === d && (g -= c.css(a, "padding" + Y[b], !0, f)),
            "margin" !== d && (g -= c.css(a, "border" + Y[b] + "Width", !0, f)))
          : ((g += c.css(a, "padding" + Y[b], !0, f)),
            "padding" !== d &&
              (g += c.css(a, "border" + Y[b] + "Width", !0, f)));
    return g;
  }
  function ob(a, b, d) {
    var e = !0,
  ...
  function lb(a) {
    ...
    d ||
      ...
      ("none" !== d && d) ||
        ...
        (b = (Z[0].contentWindow || Z[0].contentDocument).document),
  ...
  function Ia(a, b, d, e) {
    ...
    if (c.isArray(b))
      c.each(b, function (b, c) {
        d || bc.test(a)
          ? e(a, c)
          : Ia(a + "[" + ("object" === typeof c ? b : "") + "]", c, d, e);
      });
    else if (d || "object" !== c.type(b)) e(a, b);
    else for (f in b) Ia(a + "[" + f + "]", b[f], d, e);
  }
  function rb(a) {
    return function (b, d) {
  ...
  function vb(a, b, d) {
    ...
    d = l.props;
    for (dc(d, l.opts.specialEasing); f < g; f++)
      if ((b = ra[f].call(l, a, d, l.opts))) return b;
    cc(l, d);
    c.isFunction(l.opts.start) && l.opts.start.call(a, l);
    c.fx.timer(c.extend(k, { elem: a, anim: l, queue: l.opts.queue }));
    return l
  ...
  function dc(a, b) {
    ...
    for (f in a)
      if (
        ...
        (g = b[e]),
        (d = a[f]),
        c.isArray(d) && ((g = d[1]), (d = a[f] = d[0])),
        f !== e && ((a[e] = d), delete a[f]),
        (h = c.cssHooks[e]) && "expand" in h)
      )
        for (f in ((d = h.expand(d)), delete a[e], d))
          f in a || ((a[f] = d[f]), (b[f] = g));
      else b[e] = g;
  }
  function H(a, b, c, e, f) {
    return new H.prototype.init(a, b, c, e, f);
  }
  function sa(a, b) {
    var c,
      e = { height: a },
    ...
    for (b = b ? 1 : 0; 4 > f; f += 2 - b)
      (c = Y[f]), (e["margin" + c] = e["padding" + c] = a);
  ...
  var za,
    ...
    Bb = function () {
      q.addEventListener
        ? (q.removeEventListener("DOMContentLoaded", U, !1),
          n.removeEventListener("load", U, !1))
        : (q.detachEvent("onreadystatechange", U), n.detachEvent("onload", U));
    };
  c.fn = c.prototype = {
    jquery: "1.9.1",
    constructor: c,
      ...
      if (null != (f = arguments[h]))
        for (e in f)
          (a = g[e]),
            (d = f[e]),
            g !== d &&
              (l && d && (c.isPlainObject(d) || (b = c.isArray(d)))
                ? (b
  ...
  c.extend({
    ...
    isPlainObject: function (a) {
      ...
      try {
        if (
          a.constructor &&
          !ea.call(a, "constructor") &&
          !ea.call(a.constructor.prototype, "isPrototypeOf")
        )
          return !1;
      } catch (d) {
        return !1;
    ...
    parseJSON: function (a) {
      ...
      if (
        "string" === typeof a &&
        (a = c.trim(a)) &&
        kc.test(a.replace(mc, "@").replace(nc, "]").replace(lc, ""))
      )
    ...
    map: function (a, b, c) {
      var d,
        ...
        h = [];
      if (A(a))
        for (; f < g; f++) (d = b(a[f], f, c)), null != d && (h[h.length] = d);
      else for (f in a) (d = b(a[f], f, c)), null != d && (h[h.length] = d);
      return yb.apply([], h);
    },
    guid: 1,
    proxy: function (a, b) {
    ...
    access: function (a, b, d, e, f, g, h) {
      ...
      return f ? a : v ? b.call(a) : l ? b(a[0], d) : g;
    },
    now: function () {
  ...
  c.ready.promise = function (a) {
    if (!za)
      if (((za = c.Deferred()), "complete" === q.readyState))
        setTimeout(c.ready);
      else if (q.addEventListener)
        q.addEventListener("DOMContentLoaded", U, !1),
  ...
  c.Callbacks = function (a) {
    a = "string" === typeof a ? $a[a] || F(a) : c.extend({}, a);
    var b,
      d,
      e,
      f,
      ...
      v = function (c) {
        ...
        b = !1;
        k && (l ? l.length && v(l.shift()) : d ? (k = []) : M.disable());
      },
      M = {
        add: function () {
          if (k) {
            ...
            (function Ca(b) {
              c.each(b, function (b, d) {
                var e = c.type(d);
                "function" === e
                  ? (a.unique && M.has(d)) || k.push(d)
                  : d && d.length && "string" !== e && Ca(d);
              });
            })(arguments);
            b ? (f = k.length) : d && ((h = e), v(d));
          }
          return this;
        },
        remove: function () {
  ...
  c.extend({
    ...
    when: function (a) {
      var b = 0,
        ...
        p;
      if (1 < e)
        for (k = Array(e), l = Array(e), p = Array(e); b < e; b++)
  ...
  c.support = (function () {
    ...
    c(function () {
      var b,
        c,
        d = q.getElementsByTagName("body")[0];
      d &&
        ...
        n.getComputedStyle &&
          ((a.pixelPosition = "1%" !== (n.getComputedStyle(k, null) || {}).top),
          (a.boxSizingReliable =
            "4px" === (n.getComputedStyle(k, null) || { width: "4px" }).width),
          (c = k.appendChild(q.createElement("div"))),
          (c.style.cssText = k.style.cssText =
            "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;"),
          (c.style.marginRight = c.style.width = "0"),
          (k.style.width = "1px"),
          (a.reliableMarginRight = !parseFloat(
            (n.getComputedStyle(c, null) || {}).marginRight
          ))),
        typeof k.style.zoom !== O &&
          ((k.innerHTML = ""),
          (k.style.cssText =
    ...
    data: function (a, b) {
      ...
      if (a === p) {
        if (
          ...
          for (d = f.attributes; g < d.length; g++)
            (e = d[g].name),
              e.indexOf("data-") ||
                ((e = c.camelCase(e.slice(5))), ab(f, e, h[e]));
      ...
      return "object" === typeof a
        ...
        : c.access(
            this,
            function (b) {
              if (b === p) return f ? ab(f, a, c.data(f, a)) : null;
              this.each(function () {
                c.data(this, a, b);
              });
            },
  ...
  var ga,
    ...
    tc = /^(?:a|area)$/i,
    Db = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,
  ...
  c.fn.extend({
    ...
    addClass: function (a) {
      ...
      if (b)
        for (b = (a || "").match(S) || []; h < k; h++)
          if (
            ((d = this[h]),
            (e =
              1 === d.nodeType &&
              (d.className ? (" " + d.className + " ").replace(Oa, " ") : " ")))
          ) {
            for (g = 0; (f = b[g++]); )
              0 > e.indexOf(" " + f + " ") && (e += f + " ");
    ...
    toggleClass: function (a, b) {
      ...
      return c.isFunction(a)
        ...
        : this.each(function () {
            if ("string" === d)
              for (
                var f, g = 0, h = c(this), k = b, l = a.match(S) || [];
                (f = l[g++]);

              )
                (k = e ? k : !h.hasClass(f)),
                  h[k ? "addClass" : "removeClass"](f);
            else if (d === O || "boolean" === d)
    ...
    hasClass: function (a) {
      ...
      for (var b = 0, c = this.length; b < c; b++)
        if (
          1 === this[b].nodeType &&
          0 <= (" " + this[b].className + " ").replace(Oa, " ").indexOf(a)
        )
          return !0;
      return !1;
    },
        ...
        return (
          ...
          this.each(function (b) {
            ...
            1 === this.nodeType &&
              ...
              (d && "set" in d && d.set(this, b, "value") !== p) ||
                (this.value = b));
          })
        );
      if (f) {
  ...
  c.extend({
    ...
    attr: function (a, b, d) {
      ...
      f = a.nodeType;
      if (a && 3 !== f && 8 !== f && 2 !== f) {
        if (typeof a.getAttribute === O) return c.prop(a, b, d);
        if ((f = 1 !== f || !c.isXMLDoc(a)))
          (b = b.toLowerCase()), (e = c.attrHooks[b] || (Db.test(b) ? Cb : ga));
        if (d !== p)
          if (null === d) c.removeAttr(a, b);
          else {
            if (e && f && "set" in e && (g = e.set(a, d, b)) !== p) return g;
            a.setAttribute(b, d + "");
            return d;
          }
        else {
          if (e && f && "get" in e && null !== (g = e.get(a, b))) return g;
          typeof a.getAttribute !== O && (g = a.getAttribute(b));
          return null == g ? p : g;
        }
      }
    },
  ...
  Cb = {
    ...
    set: function (a, b, d) {
      !1 === b
        ? c.removeAttr(a, d)
        : (Qa && Q) || !Pa.test(d)
        ? a.setAttribute((!Q && c.propFix[d]) || d, d)
  ...
  (Qa && Q) ||
    (c.attrHooks.value = {
      ...
      set: function (a, b, d) {
        ...
        else return ga && ga.set(a, b, d);
      },
    });
  Q ||
    ((ga = c.valHooks.button = {
      get: function (a, b) {
      ...
      set: function (a, b, c) {
        ...
        d.value = b += "";
        return "value" === c || b === a.getAttribute(c) ? b : p;
      },
    }),
  ...
  c.event = {
    ...
    add: function (a, b, d, e, f) {
      var g, h, k, l, v, n, m, r, q;
      if ((k = c._data(a))) {
        d.handler && ((l = d), (d = l.handler), (f = l.selector));
        d.guid || (d.guid = c.guid++);
        (h = k.events) || (h = k.events = {});
        (v = k.handle) ||
          ((v = k.handle = function (a) {
            return typeof c === O || (a && c.event.triggered === a.type)
              ? p
              : c.event.dispatch.apply(v.elem, arguments);
          }),
          (v.elem = a));
        b = (b || "").match(S) || [""];
        for (k = b.length; k--; )
          (g = Fb.exec(b[k]) || []),
            ...
            (q = (g[2] || "").split(".").sort()),
            (g = c.event.special[r] || {}),
            (r = (f ? g.delegateType : g.bindType) || r),
            (g = c.event.special[r] || {}),
            (n = c.extend(
              {
                type: r,
            ...
            (m = h[r]) ||
              ((m = h[r] = []),
              (m.delegateCount = 0),
              (g.setup && !1 !== g.setup.call(a, e, q, v)) ||
                (a.addEventListener
                  ? a.addEventListener(r, v, !1)
                  : a.attachEvent && a.attachEvent("on" + r, v))),
            g.add &&
              (g.add.call(a, n), n.handler.guid || (n.handler.guid = d.guid)),
      ...
      if (z && (n = z.events)) {
        ...
        for (p = b.length; p--; )
          if (
            ...
            l &&
              !r.length &&
              ((m.teardown && !1 !== m.teardown.call(a, Na, z.handle)) ||
                c.removeEvent(a, q, z.handle),
              delete n[q]);
          } else for (q in n) c.event.remove(a, q + b[p], d, e, !0);
    ...
    trigger: function (a, b, d, e) {
      var f,
        ...
        v,
        M = [d || q],
        m = ea.call(a, "type") ? a.type : a;
      l = ea.call(a, "namespace") ? a.namespace.split(".") : [];
      h = f = d = d || q;
      if (
        3 !== d.nodeType &&
        8 !== d.nodeType &&
        !Eb.test(m + c.event.triggered) &&
        ...
        if (!e && !l.noBubble && !c.isWindow(d)) {
          k = l.delegateType || m;
          Eb.test(k + m) || (h = h.parentNode);
          for (; h; h = h.parentNode) M.push(h), (f = h);
          f === (d.ownerDocument || q) &&
            M.push(f.defaultView || f.parentWindow || n);
        }
        for (v = 0; (h = M[v++]) && !a.isPropagationStopped(); )
          (a.type = 1 < v ? k : l.bindType || m),
            (f =
  ...
  c.removeEvent = q.removeEventListener
    ...
    : function (a, b, c) {
        b = "on" + b;
        a.detachEvent &&
          (typeof a[b] === O && (a[b] = null), a.detachEvent(b, c));
      };
    ...
    (c.event.special.submit = {
      setup: function () {
        ...
        c.event.add(this, "click._submit keypress._submit", function (a) {
          a = a.target;
          (a =
            c.nodeName(a, "input") || c.nodeName(a, "button") ? a.form : p) &&
  ...
  c.fn.extend({
    ...
    off: function (a, b, d) {
      ...
      if (!1 === b || "function" === typeof b) (d = b), (b = p);
      !1 === d && (d = X);
      return this.each(function () {
  ...
  (function (a, b) {
      ...
      if (!y && !d) {
        if ((e = oa.exec(a)))
          if ((g = e[1]))
            ...
            if (e[2])
              return P.apply(c, Q.call(b.getElementsByTagName(a), 0)), c;
            if ((g = e[3]) && D.getByClassName && b.getElementsByClassName)
              return P.apply(c, Q.call(b.getElementsByClassName(g), 0)), c;
          }
        if (D.qsa && !aa.test(a)) {
          e = !0;
          f = x;
          ...
          if (k)
            try {
              return P.apply(c, Q.call(g.querySelectorAll(k), 0)), c;
            } catch (Vc) {
            } finally {
      ...
      a: {
        ...
        if (!d && 1 === f.length) {
          ...
          if (
            ...
            b = t.find.ID(u.matches[0].replace(ia, ja), b)[0];
            if (!b) {
              u = c;
              break a;
            }
          ...
          for (h = Z.needsContext.test(a) ? 0 : e.length; h--; ) {
            u = e[h];
            if (t.relative[(g = u.type)]) break;
            if ((g = t.find[g]))
              if (
                (d = g(
                  u.matches[0].replace(ia, ja),
                  (da.test(e[0].type) && b.parentNode) || b
                ))
              ) {
                e.splice(h, 1);
                a = d.length && m(e);
                if (!a) {
                  P.apply(c, Q.call(d, 0));
                  u = c;
                  break a;
                }
                break;
    ...
    function n(a, b) {
      var c, d, e, f, h, k, u;
      if ((h = W[a + " "])) return b ? 0 : h.slice(0);
      h = a;
      k = [];
      for (u = t.preFilter; h; ) {
        if (!c || (d = ga.exec(h)))
          d && (h = h.slice(d[0].length) || h), k.push((e = []));
        c = !1;
        if ((d = ka.exec(h)))
          (c = d.shift()),
            e.push({ value: c, type: d[0].replace(T, " ") }),
            (h = h.slice(c.length));
        for (f in t.filter)
          !(d = Z[f].exec(h)) ||
            (u[f] && !(d = u[f](d))) ||
            ((c = d.shift()),
            e.push({ value: c, type: f, matches: d }),
            (h = h.slice(c.length)));
        if (!c) break;
      }
      return b ? h.length : h ? g.error(a) : W(a, k).slice(0);
    }
    function m(a) {
      ...
      return b.first
        ...
        : function (b, c, g) {
            ...
            if (g)
              ...
              for (; (b = b[d]); )
                if (1 === b.nodeType || e)
                  if (((u = b[x] || (b[x] = {})), (k = u[d]) && k[0] === C)) {
                    if (!0 === (h = k[1]) || h === F) return !0 === h;
                  } else if (
                    ((k = u[d] = [C]), (k[1] = a(b, c, g) || F), !0 === k[1])
                  )
                    return !0;
          };
    }
    ...
    function z(a, b, c, d, e) {
      for (var f, g = [], h = 0, k = a.length, u = null != b; h < k; h++)
        if ((f = a[h])) if (!c || c(f, d, e)) g.push(f), u && b.push(h);
      return g;
    }
    function A(a, b, c, d, f, h) {
      d && !d[x] && (d = A(d));
      f && !f[x] && (f = A(f, h));
      return e(function (e, h, k, u) {
        var C,
          l,
          ha = [],
          m = [],
        ...
        if (!(K = e)) {
          K = b || "*";
          for (
            var n = k.nodeType ? [k] : k, r = [], wa = 0, q = n.length;
            wa < q;
            wa++
          )
            g(K, n[wa], r);
        ...
        K = !a || (!e && b) ? K : z(K, ha, a, k, u);
        n = c ? (f || (e ? a : p || d) ? [] : h) : K;
        c && c(K, n, k, u);
        if (d)
          for (C = z(n, m), d(C, [], k, u), k = C.length; k--; )
            if ((l = C[k])) n[m[k]] = !(K[m[k]] = l);
        if (e) {
          if (f || a) {
            if (f) {
              C = [];
              for (k = n.length; k--; ) (l = n[k]) && C.push((K[k] = l));
              f(null, (n = []), C, u);
            }
            for (k = n.length; k--; )
              (l = n[k]) &&
                -1 < (C = f ? V.call(e, l) : ha[k]) &&
                (e[C] = !(h[C] = l));
          }
        } else (n = z(n === h ? n.splice(p, n.length) : n)), f ? f(null, h, n, u) : P.apply(h, n);
      });
    }
    function H(a) {
      var b,
      ...
      for (
        ...
        if ((c = t.relative[a[g].type])) u = [r(q(u), c)];
        else {
          ...
          if (c[x]) {
            ...
            return A(
              1 < g && q(u),
              1 < g && m(a.slice(0, g - 1)).replace(T, "$1"),
              c,
              g < d && H(a.slice(g, d)),
              d < e && H((a = a.slice(d))),
              d < e && m(a)
      ...
      var c = 0,
        ...
        h = function (e, h, k, u, C) {
          var l,
            ...
            r = null != C,
            q = Da,
            wa = e || (f && t.find.TAG("*", (C && h.parentNode) || h)),
            v = (E += null == q ? 1 : Math.random() || 0.1);
          r && ((Da = h !== N && h), (F = c));
          for (; null != (C = wa[n]); n++) {
            if (f && C) {
              for (l = 0; (ha = a[l++]); )
            ...
            d && ((C = !ha && C) && p--, e && K.push(C));
          }
          p += n;
          if (d && n !== p) {
            for (l = 0; (ha = b[l++]); ) ha(K, m, h, k);
            if (e) {
              if (0 < p) for (; n--; ) K[n] || m[n] || (m[n] = ca.call(u));
              m = z(m);
            }
            P.apply(u, m);
            r && !e && 0 < m.length && 1 < p + b.length && g.uniqueSort(u);
          }
          r && ((E = v), (Da = q));
          return K;
        };
    ...
    try {
      Q.call(na.documentElement.childNodes, 0)[0].nodeType;
    } catch (u) {
      Q = function (a) {
    ...
    ya = g.isXML = function (a) {
      return (a = a && (a.ownerDocument || a).documentElement)
        ? "HTML" !== a.nodeName
        : !1;
    };
    ta = g.setDocument = function (a) {
      var c = a ? a.ownerDocument || a : na;
      if (c === N || 9 !== c.nodeType || !c.documentElement) return N;
      N = c;
      R = c.documentElement;
      y = ya(c);
      D.tagNameNoComments = f(function (a) {
        a.appendChild(c.createComment(""));
        return !a.getElementsByTagName("*").length;
      });
      D.attributes = f(function (a) {
        a.innerHTML = "<select></select>";
        a = typeof a.lastChild.getAttribute("multiple");
        return "boolean" !== a && "string" !== a;
      });
      D.getByClassName = f(function (a) {
      ...
      D.getByName = f(function (a) {
        a.id = x + 0;
        a.innerHTML = "<a name='" + x + "'></a><div name='" + x + "'></div>";
        R.insertBefore(a, R.firstChild);
        var b =
          c.getElementsByName &&
          c.getElementsByName(x).length ===
            2 + c.getElementsByName(x + 0).length;
        D.getIdNotName = !c.getElementById(x);
        R.removeChild(a);
        return b;
      });
      t.attrHandle = f(function (a) {
        a.innerHTML = "<a href='#'></a>";
        return (
          a.firstChild &&
          typeof a.firstChild.getAttribute !== fa &&
      ...
      D.getIdNotName
        ? ((t.find.ID = function (a, b) {
            if (typeof b.getElementById !== fa && !y) {
        ...
        : ((t.find.ID = function (a, c) {
            if (typeof c.getElementById !== fa && !y) {
              var d = c.getElementById(a);
              return d
                ? d.id === a ||
                  (typeof d.getAttributeNode !== fa &&
          ...
          (t.filter.ID = function (a) {
            ...
            return function (a) {
              return (
                (a =
                  typeof a.getAttributeNode !== fa &&
                  a.getAttributeNode("id")) && a.value === b
              );
            };
          }));
      t.find.TAG = D.tagNameNoComments
        ? function (a, b) {
            if (typeof b.getElementsByTagName !== fa)
      ...
      t.find.NAME =
        D.getByName &&
        function (a, b) {
          if (typeof b.getElementsByName !== fa)
            return b.getElementsByName(name);
        };
      t.find.CLASS =
        D.getByClassName &&
        function (a, b) {
          if (typeof b.getElementsByClassName !== fa && !y)
            return b.getElementsByClassName(a);
        };
      va = [];
      aa = [":focus"];
      if ((D.qsa = ea.test(c.querySelectorAll + "")))
        f(function (a) {
          ...
          a.querySelectorAll(":checked").length || aa.push(":checked");
        }),
          f(function (a) {
      ...
      (D.matchesSelector = ea.test(
        ...
        f(function (a) {
          D.disconnectedMatch = I.call(a, "div");
          I.call(a, "[s!='']:x");
          va.push("!=", X);
        });
      aa = new RegExp(aa.join("|"));
      va = new RegExp(va.join("|"));
      xa =
        ea.test(R.contains + "") || R.compareDocumentPosition
          ? function (a, b) {
      ...
      O = R.compareDocumentPosition
        ...
        : function (a, b) {
            ...
            if (!d || !f)
              return a === c ? -1 : b === c ? 1 : d ? -1 : f ? 1 : 0;
            if (d === f) return h(a, b);
            for (d = a; (d = d.parentNode); ) g.unshift(d);
            for (d = b; (d = d.parentNode); ) k.unshift(d);
            for (; g[e] === k[e]; ) e++;
            return e ? h(g[e], k[e]) : g[e] === na ? -1 : k[e] === na ? 1 : 0;
          };
      ua = !1;
      [0, 0].sort(O);
      D.detectDuplicates = ua;
      return N;
    };
    ...
    g.matchesSelector = function (a, b) {
      (a.ownerDocument || a) !== N && ta(a);
      b = b.replace(sa, "='$1']");
      if (!(!D.matchesSelector || y || (va && va.test(b)) || aa.test(b)))
        try {
          var c = I.call(a, b);
          if (
            c ||
    ...
    L = g.getText = function (a) {
      var b,
        c = "",
        d = 0;
      b = a.nodeType;
      if (!b) for (; (b = a[d]); d++) c += L(b);
    ...
    t = g.selectors = {
        ...
        CLASS: function (a) {
          ...
          return (
            ...
            U(a, function (a) {
              return b.test(
                a.className ||
                  (typeof a.getAttribute !== fa && a.getAttribute("class")) ||
                  ""
              );
            }))
          );
                ...
                if (r) {
                  if (f) {
                    for (; c; ) {
                      for (m = b; (m = m[c]); )
                        if (
                          h ? m.nodeName.toLowerCase() === q : 1 === m.nodeType
                        )
                          return !1;
      ...
      pseudos: {
        ...
        lang: e(function (a) {
          ma.test(a || "") || g.error("unsupported lang: " + a);
          a = a.replace(ia, ja).toLowerCase();
          return function (b) {
            var c;
            do
    ...
    for (J in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
      t.pseudos[J] = k(J);
    for (J in { submit: !0, reset: !0 }) t.pseudos[J] = l(J);
    Sa = g.compile = function (a, b) {
      var c,
        d = [],
        e = [],
        f = Y[a + " "];
      if (!f) {
        b || (b = n(a));
        for (c = b.length; c--; ) (f = H(b[c])), f[x] ? d.push(f) : e.push(f);
        f = Y(a, G(e, d));
      }
      return f;
    };
    t.pseudos.nth = t.pseudos.eq;
    t.filters = w.prototype = t.pseudos;
    t.setFilters = new w();
    ta();
    g.attr = c.attr;
    c.find = g;
  ...
  var xc = /Until$/,
    yc = /^(?:parents|prev(?:Until|All))/,
    Xb = /^.[^:#\[\.,]*$/,
    Gb = c.expr.match.needsContext,
    ...
    closest: function (a, b) {
      for (
        var d,
          ...
          f = this.length,
          g = [],
          h = Gb.test(a) || "string" !== typeof a ? c(a, b || this.context) : 0;
        e < f;
        e++
      )
        for (
  ...
  c.each(
    ...
    function (a, b) {
      c.fn[a] = function (d, e) {
        ...
        f = 1 < this.length && !zc[a] ? c.unique(f) : f;
        1 < this.length && yc.test(a) && (f = f.reverse());
  ...
  c.extend({
    ...
    dir: function (a, b, d) {
      ...
      for (
        a = a[b];
        a && 9 !== a.nodeType && (d === p || 1 !== a.nodeType || !c(a).is(d));
  ...
  var eb =
    ...
    Ua = db(q).appendChild(q.createElement("div"));
  w.optgroup = w.option;
  ...
  c.fn.extend({
    ...
    remove: function (a, b) {
      for (var d, e = 0; null != (d = this[e]); e++)
        if (!a || 0 < c.filter(a, [d]).length)
          b || 1 !== d.nodeType || c.cleanData(z(d)),
            d.parentNode &&
              (b && c.contains(d.ownerDocument, d) && Ga(z(d, "script")),
              d.parentNode.removeChild(d));
      return this;
    },
    empty: function () {
      for (var a, b = 0; null != (a = this[b]); b++) {
        for (1 === a.nodeType && c.cleanData(z(a, !1)); a.firstChild; )
      ...
      return c.access(
        ...
        function (a) {
          var b = this[0] || {},
            ...
            f = this.length;
          if (a === p)
            return 1 === b.nodeType ? b.innerHTML.replace(Ac, "") : p;
          if (
            !(
              "string" !== typeof a ||
              Cc.test(a) ||
              (!c.support.htmlSerialize && Hb.test(a)) ||
              (!c.support.leadingWhitespace && Ta.test(a)) ||
              w[(Jb.exec(a) || ["", ""])[1].toLowerCase()]
            )
          ) {
            a = a.replace(Ib, "<$1></$2>");
            try {
              for (; e < f; e++)
                (b = this[e] || {}),
                  1 === b.nodeType &&
                    (c.cleanData(z(b, !1)), (b.innerHTML = a));
              b = 0;
            } catch (g) {}
          }
    ...
    domManip: function (a, b, d) {
      ...
      if (
        r ||
        (!(1 >= l || "string" !== typeof m || c.support.checkClone) &&
          Dc.test(m))
      )
        return this.each(function (c) {
          var e = n.eq(c);
          r && (a[0] = m.call(this, c, b ? e.html() : p));
          e.domManip(a, b, d);
        });
      if (
        l &&
        ...
        b = b && c.nodeName(e, "tr");
        g = c.map(z(h, "script"), fb);
        for (f = g.length; k < l; k++)
          (e = h),
            k !== q &&
              ((e = c.clone(e, !0, !0)), f && c.merge(g, z(e, "script"))),
            d.call(
              b && c.nodeName(this[k], "table")
                ? Yb(this[k], "tbody")
                : this[k],
              e,
              k
        ...
        if (f)
          for (
            h = g[g.length - 1].ownerDocument, c.map(g, gb), k = 0;
            k < f;
            k++
          )
            (e = g[k]),
  ...
  c.extend({
    clone: function (a, b, d) {
      ...
      c.support.html5Clone || c.isXMLDoc(a) || !Hb.test("<" + a.nodeName + ">")
        ? (g = a.cloneNode(!0))
        : ((Ua.innerHTML = a.outerHTML), Ua.removeChild((g = Ua.firstChild)));
      if (
        !(
        ...
        for (e = z(g), k = z(a), h = 0; null != (f = k[h]); ++h)
          if (e[h]) {
            var p = void 0,
              n,
              m = f,
            ...
            if (1 === r.nodeType) {
              ...
              if (!c.support.noCloneEvent && r[c.expando]) {
                f = c._data(r);
                for (p in f.events) c.removeEvent(r, p, f.handle);
                r.removeAttribute(c.expando);
              }
              if ("script" === n && r.text !== m.text)
                (fb(r).text = m.text), gb(r);
              else if ("object" === n)
                r.parentNode && (r.outerHTML = m.outerHTML),
                  c.support.html5Clone &&
                    m.innerHTML &&
                    !c.trim(r.innerHTML) &&
                    (r.innerHTML = m.innerHTML);
              else if ("input" === n && Ha.test(m.type))
                (r.defaultChecked = r.checked = m.checked),
                  r.value !== m.value && (r.value = m.value);
              else if ("option" === n)
                r.defaultSelected = r.selected = m.defaultSelected;
      ...
      if (b)
        if (d)
          for (k = k || z(a), e = e || z(g), h = 0; null != (f = k[h]); h++)
            hb(f, e[h]);
        else hb(a, g);
      e = z(g, "script");
      0 < e.length && Ga(e, !l && z(a, "script"));
      return g;
    },
    buildFragment: function (a, b, d, e) {
      for (
        var f, g, h, k, l, p, n = a.length, m = db(b), r = [], q = 0;
        q < n;
        q++
      )
        if ((g = a[q]) || 0 === g)
          if ("object" === c.type(g)) c.merge(r, g.nodeType ? [g] : g);
            ...
            k = (Jb.exec(g) || ["", ""])[1].toLowerCase();
            p = w[k] || w._default;
            h.innerHTML = p[1] + g.replace(Ib, "<$1></$2>") + p[2];
            for (f = p[0]; f--; ) h = h.lastChild;
            !c.support.leadingWhitespace &&
              Ta.test(g) &&
              r.push(b.createTextNode(Ta.exec(g)[0]));
            if (!c.support.tbody)
              for (
                f =
                  (g =
      ...
      h && m.removeChild(h);
      c.support.appendChecked || c.grep(z(r, "input"), $b);
      for (q = 0; (g = r[q++]); )
        if (!e || -1 === c.inArray(g, e))
          if (
            ((a = c.contains(g.ownerDocument, g)),
            (h = z(m.appendChild(g), "script")),
            a && Ga(h),
            d)
          )
            for (f = 0; (g = h[f++]); ) Lb.test(g.type || "") && d.push(g);
      return m;
    },
  ...
  var Z,
    ...
    Mb = /^margin/,
    ac = new RegExp("^(" + Ba + ")(.*)$", "i"),
    qa = new RegExp("^(" + Ba + ")(?!px)[a-z%]+$", "i"),
    Ic = new RegExp("^([+-])=(" + Ba + ")", "i"),
    pb = { BODY: "block" },
    Jc = { position: "absolute", visibility: "hidden", display: "block" },
  ...
  c.fn.extend({
    ...
    toggle: function (a) {
      ...
      return this.each(function () {
        (b ? a : ma(this)) ? c(this).show() : c(this).hide();
      });
    },
  });
  c.extend({
    ...
    style: function (a, b, d, e) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        ...
        } else return h && "get" in h && (f = h.get(a, !1, e)) !== p ? f : l[b];
      }
    },
  ...
  n.getComputedStyle
    ? ((B = function (a) {
      ...
      (ca = function (a, b, d) {
        var e,
          f = (d = d || B(a)) ? d.getPropertyValue(b) || d[b] : p,
          g = a.style;
        d &&
  ...
  c.each(["height", "width"], function (a, b) {
    c.cssHooks[b] = {
      get: function (a, e, f) {
        if (e)
          return 0 === a.offsetWidth && Hc.test(c.css(a, "display"))
            ? c.swap(a, Jc, function () {
                return ob(a, b, f);
              })
            : ob(a, b, f);
      },
    ...
    (c.cssHooks.opacity = {
      ...
      set: function (a, b) {
        ...
        if (
          ...
          "" === c.trim(g.replace(Va, "")) &&
          d.removeAttribute &&
          (d.removeAttribute("filter"), "" === b || (e && !e.filter))
        )
          return;
  ...
  c(function () {
    c.support.reliableMarginRight ||
      (c.cssHooks.marginRight = {
        get: function (a, b) {
          if (b)
            return c.swap(a, { display: "inline-block" }, ca, [
              a,
              "marginRight",
            ]);
        },
    ...
    !c.support.pixelPosition &&
      ...
      c.each(["top", "left"], function (a, b) {
        c.cssHooks[b] = {
          get: function (a, e) {
            if (e)
              return (e = ca(a, b)), qa.test(e) ? c(a).position()[b] + "px" : e;
          },
        };
      });
  });
    ...
    c.cssHooks[a + b] = {
      expand: function (c) {
        ...
        for (c = "string" === typeof c ? c.split(" ") : [c]; 4 > d; d++)
          f[a + Y[d] + b] = c[d] || c[d - 2] || c[0];
        return f;
      },
    };
    Mb.test(a) || (c.cssHooks[a + b].set = mb);
  });
  var Kc = /%20/g,
    bc = /\[\]$/,
    Ob = /\r?\n/g,
      ...
      return this.map(function () {
        ...
        .map(function (a, b) {
          ...
          return null == d
            ...
            : c.isArray(d)
            ? c.map(d, function (a) {
                return { name: b.name, value: a.replace(Ob, "\r\n") };
              })
  ...
  try {
    ...
    (W = q.createElement("a")), (W.href = ""), (W = W.href);
  }
  V = Qb.exec(W.toLowerCase()) || [];
  ...
  c.extend({
    ...
    ajaxSetup: function (a, b) {
      return b ? Ka(Ka(a, c.ajaxSettings), b) : Ka(c.ajaxSettings, a);
    },
    ajaxPrefilter: rb(Sb),
    ajaxTransport: rb(Ja),
    ajax: function (a, b) {
        ...
        if (2 !== J) {
          ...
          if (d) {
            ...
            var M,
              ...
              x = L.dataTypes,
              ya = L.responseFields;
            for (w in ya) w in d && (e[ya[w]] = d[w]);
            for (; "*" === x[0]; )
              x.shift(),
                B === p &&
                  (B = L.mimeType || e.getResponseHeader("Content-Type"));
            if (B)
              for (w in G)
                if (G[w] && G[w].test(B)) {
                  x.unshift(w);
            ...
            I ? (I !== x[0] && x.unshift(I), (L = d[I])) : (L = void 0);
          }
          if ((200 <= a && 300 > a) || 304 === a)
            if (
              (m.ifModified &&
                ((d = t.getResponseHeader("Last-Modified")) &&
                  (c.lastModified[g] = d),
                (d = t.getResponseHeader("etag")) && (c.etag[g] = d)),
              204 === a)
            )
              (f = !0), (y = "nocontent");
            else if (304 === a) (f = !0), (y = "notmodified");
            else {
              a: {
                q = m;
                v = L;
                ...
                B = q.dataTypes.slice();
                I = B[0];
                q.dataFilter && (v = q.dataFilter(v, q.dataType));
                if (B[1])
                  for (E in q.converters) y[E.toLowerCase()] = q.converters[E];
                for (; (d = B[++M]); )
                  if ("*" !== d) {
                    if ("*" !== I && I !== d) {
                      E = y[I + " " + d] || y["* " + d];
          ...
          else if (((v = y), a || !y)) (y = "error"), 0 > a && (a = 0);
          t.status = a;
          t.statusText = (b || y) + "";
          f ? A.resolveWith(r, [q, y, t]) : A.rejectWith(r, [t, y, v]);
          t.statusCode(F);
          F = p;
          l && z.trigger(f ? "ajaxSuccess" : "ajaxError", [t, m, f ? q : v]);
          H.fireWith(r, [t, y]);
          l &&
            (z.trigger("ajaxComplete", [t, m]),
      ...
      var e,
        ...
        m = c.ajaxSetup({}, b),
        r = m.context || m,
        z = m.context && (r.nodeType || r.jquery) ? c(r) : c.event,
        A = c.Deferred(),
        ...
        t = {
          ...
          getResponseHeader: function (a) {
            ...
            if (2 === J) {
              if (!q)
                for (q = {}; (b = Oc.exec(h)); ) q[b[1].toLowerCase()] = b[2];
              b = q[a.toLowerCase()];
            }
      ...
      A.promise(t).complete = H.add;
      t.success = t.done;
      t.error = t.fail;
      m.url = ((a || m.url || W) + "").replace(Nc, "").replace(Qc, V[1] + "//");
      ...
      m.hasContent ||
        (m.data &&
          ((g = m.url += (Xa.test(g) ? "&" : "?") + m.data), delete m.data),
        !1 === m.cache &&
          (m.url = Pb.test(g)
            ? g.replace(Pb, "$1_=" + Wa++)
            : g + (Xa.test(g) ? "&" : "?") + "_=" + Wa++));
      m.ifModified &&
        (c.lastModified[g] &&
          t.setRequestHeader("If-Modified-Since", c.lastModified[g]),
      ...
      if (m.beforeSend && (!1 === m.beforeSend.call(r, t, m) || 2 === J))
        return t.abort();
      G = "abort";
      for (f in { success: 1, error: 1, complete: 1 }) t[f](m[f]);
      if ((n = sb(Ja, m, b, t))) {
        t.readyState = 1;
        l && z.trigger("ajaxSend", [t, m]);
        m.async &&
          0 < m.timeout &&
    ...
    if (h || "jsonp" === a.dataTypes[0])
      return (
        (e = a.jsonpCallback = c.isFunction(a.jsonpCallback)
          ...
          : a.jsonpCallback),
        h
          ? (a[h] = a[h].replace(Ya, "$1" + e))
          : !1 !== a.jsonp &&
            (a.url += (Xa.test(a.url) ? "&" : "?") + a.jsonp + "=" + e),
        ...
        d.always(function () {
          n[e] = f;
          a[e] && ((a.jsonpCallback = b.jsonpCallback), Ub.push(e));
  ...
  var ka,
    ...
    Za =
      n.ActiveXObject &&
      function () {
        for (var a in ka) ka[a](p, !0);
      };
  c.ajaxSettings.xhr = n.ActiveXObject
    ? function () {
        var a;
    ...
    : tb;
  oa = c.ajaxSettings.xhr();
  c.support.cors = !!oa && "withCredentials" in oa;
  (oa = c.support.ajax = !!oa) &&
            ...
            b = function (d, g) {
              ...
              try {
                if (b && (g || 4 === h.readyState))
                  if (
                    ((b = p),
                    f && ((h.onreadystatechange = c.noop), Za && delete ka[f]),
                    g)
                  )
    ...
    ra = [
      function (a, b, d) {
        ...
        1 === a.nodeType &&
          ...
          ((d.overflow = [p.overflow, p.overflowX, p.overflowY]),
          "inline" === c.css(a, "display") &&
            "none" === c.css(a, "float") &&
            (c.support.inlineBlockNeedsLayout && "inline" !== lb(a.nodeName)
              ? (p.zoom = 1)
        ...
        function (a, b) {
          ...
          if (g) {
            ...
            if ("px" !== e && k) {
              ...
              do (l = l || ".5"), (k /= l), c.style(f.elem, a, k + e);
  ...
  c.fn.extend({
    ...
    stop: function (a, b, d) {
      ...
      return this.each(function () {
        ...
        else for (g in k) k[g] && k[g].stop && Uc.test(g) && e(k[g]);
        for (g = h.length; g--; )
          h[g].elem !== this ||
            (null != a && h[g].queue !== a) ||
  ...
  c.fn.offset = function (a) {
    ...
    if (f) {
      ...
      typeof d.getBoundingClientRect !== O && (e = d.getBoundingClientRect());
      d = wb(f);
      return {
  ...
  c.each({ Height: "height", Width: "width" }, function (a, b) {
    c.each({ padding: "inner" + a, content: b, "": "outer" + a }, function (
      d,
      e
    ) {
      c.fn[e] = function (e, g) {
