...
def is_module_detected():
    ...
    return (pyautogui.locateOnScreen('./Picture/available_network_latest.png', confidence=0.9) != None) or (pyautogui.locateOnScreen('./Picture/current_network_latest.png', confidence=0.9) != None) or (pyautogui.locateOnScreen('./Picture/module_detected_post_bfu_network_changed.png', confidence=0.9) != None)
